...
export function useThemeManager() {
  ...
  const updateBrandColorsFromTheme = React.useCallback((styles) => {
    const newValues = {}
  ...
  const applyTheme = React.useCallback((themeValue, darkMode) => {
  ...
  const applyTweakcnTheme = React.useCallback((themePreset, darkMode) => {
    // Reset and apply theme variables
    resetTheme()
  ...
  const applyImportedTheme = React.useCallback((themeData, darkMode) => {
    const root = document.documentElement
