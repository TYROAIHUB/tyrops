...
export const shadcnThemePresets = {
  "default": {
    label: "Default",
    styles: {
      light: {
  ...
  "tyro": {
    ...
    styles: {
      light: {
        ...
        muted: "oklch(0.97 0 0)",
        "muted-foreground": "oklch(0.556 0 0)",
        accent: "oklch(0.94 0.05 278)",
        "accent-foreground": "oklch(0.35 0.18 278)",
        destructive: "oklch(0.577 0.245 27.325)",
        "destructive-foreground": "oklch(0.98 0 0)",
        border: "oklch(0.922 0 0)",
        input: "oklch(0.922 0 0)",
        ring: "oklch(0.55 0.22 278)",
        "chart-1": "oklch(0.55 0.22 278)",
        "chart-2": "oklch(0.65 0.18 278)",
        "chart-3": "oklch(0.45 0.22 278)",
        "chart-4": "oklch(0.75 0.14 278)",
        "chart-5": "oklch(0.35 0.20 278)",
        radius: "0.625rem",
        "font-sans": "ui-sans-serif, system-ui, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
        "font-mono": "ui-monospace, SFMono-Regular, 'SF Mono', Consolas, 'Liberation Mono', Menlo, monospace",
      },
      dark: {
        ...
        popover: "oklch(0.269 0 0)",
        "popover-foreground": "oklch(0.985 0 0)",
        primary: "oklch(0.60 0.22 278)",
        "primary-foreground": "oklch(1 0 0)",
        secondary: "oklch(0.269 0 0)",
        "secondary-foreground": "oklch(0.985 0 0)",
        muted: "oklch(0.269 0 0)",
        "muted-foreground": "oklch(0.708 0 0)",
        accent: "oklch(0.30 0.12 278)",
        "accent-foreground": "oklch(0.85 0.08 278)",
        destructive: "oklch(0.704 0.191 22.216)",
        "destructive-foreground": "oklch(0.98 0 0)",
        border: "oklch(1 0 0 / 10%)",
        input: "oklch(1 0 0 / 15%)",
        ring: "oklch(0.60 0.22 278)",
        "chart-1": "oklch(0.65 0.20 278)",
        "chart-2": "oklch(0.55 0.22 278)",
        "chart-3": "oklch(0.75 0.16 278)",
        "chart-4": "oklch(0.45 0.22 278)",
        "chart-5": "oklch(0.80 0.12 278)",
        radius: "0.625rem",
        "font-sans": "ui-sans-serif, system-ui, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
        "font-mono": "ui-monospace, SFMono-Regular, 'SF Mono', Consolas, 'Liberation Mono', Menlo, monospace",
      }
